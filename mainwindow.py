...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(320, 447)
        MainWindow.setMinimumSize(QtCore.QSize(320, 447))
        MainWindow.setMaximumSize(QtCore.QSize(320, 447))
        icon = QtGui.QIcon()
        ...
        self.genButton.setGeometry(QtCore.QRect(100, 360, 121, 31))
        font = QtGui.QFont()
        ...
        self.p1Box = QtWidgets.QSpinBox(self.centralwidget)
        self.p1Box.setGeometry(QtCore.QRect(110, 320, 42, 22))
        self.p1Box.setObjectName("p1Box")
        self.p2Box = QtWidgets.QSpinBox(self.centralwidget)
        self.p2Box.setGeometry(QtCore.QRect(170, 320, 42, 22))
        self.p2Box.setObjectName("p2Box")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(90, 290, 141, 21))
        font = QtGui.QFont()
        font.setFamily("Optima")
        font.setPointSize(10)
        font.setBold(True)
        ...
        MainWindow.setTabOrder(self.super_earth_checkBox, self.p1Box)
        MainWindow.setTabOrder(self.p1Box, self.p2Box)
        MainWindow.setTabOrder(self.p2Box, self.genButton)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "SectorGen 0.6.0 (Beta)"))
        self.genButton.setToolTip(_translate("MainWindow", "Generate Sector"))
        ...
        self.p1Box.setToolTip(_translate("MainWindow", "Trailing"))
        self.p2Box.setToolTip(_translate("MainWindow", "Rimward"))
        self.label_3.setText(_translate("MainWindow", "Sector Coordinates"))
