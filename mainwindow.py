...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.genButton.setGeometry(QtCore.QRect(110, 180, 121, 31))
        font = QtGui.QFont()
        ...
        self.hydroBox.setGeometry(QtCore.QRect(110, 100, 171, 22))
        font = QtGui.QFont()
        font.setFamily("Optima")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.world_chanceBox = QtWidgets.QComboBox(self.centralwidget)
        self.world_chanceBox.setGeometry(QtCore.QRect(110, 140, 91, 22))
        font = QtGui.QFont()
        font.setFamily("Optima")
        font.setPointSize(10)
        font.setBold(True)
        font.setItalic(False)
        font.setWeight(75)
        self.world_chanceBox.setFont(font)
        self.world_chanceBox.setMaxVisibleItems(17)
        self.world_chanceBox.setMaxCount(17)
        self.world_chanceBox.setObjectName("world_chanceBox")
        self.world_chanceLabel = QtWidgets.QLabel(self.centralwidget)
        self.world_chanceLabel.setGeometry(QtCore.QRect(10, 140, 101, 20))
        font = QtGui.QFont()
        font.setFamily("Optima")
        font.setPointSize(10)
        font.setBold(True)
        font.setItalic(False)
        font.setWeight(75)
        self.world_chanceLabel.setFont(font)
        self.world_chanceLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.world_chanceLabel.setObjectName("world_chanceLabel")
        ...
        MainWindow.setTabOrder(self.hydroBox, self.world_chanceBox)
        MainWindow.setTabOrder(self.world_chanceBox, self.genButton)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "SectorGen 0.0.1 (Beta)"))
        ...
        self.world_chanceLabel.setText(_translate("MainWindow", "World Chance"))
